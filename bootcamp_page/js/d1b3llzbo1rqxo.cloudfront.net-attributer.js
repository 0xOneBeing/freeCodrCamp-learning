(function () {
  ...
  var FlareTrk_Class = function FlareTrk_Class() {
    ...
    _defineProperty(this, "attributerDecode", function (s) {
      if (s.startsWith("%2")) {
        var binString = atob(s.slice(2));
    ...
    _defineProperty(this, "attributerEncode", function (s) {
      var v = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
    ...
    _defineProperty(this, "processCustomData", function () {
      ...
      var hhh = _this.pathparts(_this.data.landingURL).href;
      ...
      for (var dp = 0; dp < fieldNames.length; dp++) {
        ...
        if (_this.data["customFields"][key]) {
          ...
          points[fieldNames[dp]] = decodeURIComponent(_this.getParam(hhh, key));
        }
      }
    ...
    _defineProperty(this, "getCookie", function (name) {
      ...
      return results ? JSON.parse(_this.attributerDecode(results[1])) : null;
    });
    ...
    _defineProperty(this, "setCookie", function (value, name) {
      ...
      for (var i = parts.length - 2; i >= 0; i--) {
        ...
        var cookie_value = "".concat(name, "=").concat(_this.attributerEncode(JSON.stringify(value)));
    ...
    _defineProperty(this, "getUTMParam", function (url, key) {
      var toLower = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
      var param = key === "gclid" || key === "fbclid" || key === "msclkid" ? key : "utm_".concat(key);

      var result = _this.getParam(url, param.toLowerCase());
    ...
    _defineProperty(this, "getDrillSubSource", function (drillSource, pathparts, queryVars) {
      switch (drillSource) {
        ...
        case "Organic social":
          var drill_source = _this.getUTMParam(pathparts.href, "source", false);
    ...
    _defineProperty(this, "getDrillSourceDetail", function (drillSource, pathparts, queryVars) {
      switch (drillSource) {
        ...
        case "Affiliates":
          ...
          var dsd_campaign = _this.getUTMParam(pathparts.href, "campaign", false);
        ...
        case "Organic social":
          var term = _this.getUTMParam(pathparts.href, "campaign", false);
    ...
    _defineProperty(this, "getDrillSourceSubdetail", function (drillSource, pathparts, queryVars) {
      switch (drillSource) {
        case "Organic search":
          var term = _this.getUTMParam(pathparts.href, "term", false);
    ...
    _defineProperty(this, "getDrillSourceSubSubdetail", function (drillSource, pathparts, queryVars) {
      switch (drillSource) {
        ...
        case "Organic social":
          var content = _this.getUTMParam(pathparts.href, "content", false);
        ...
        case "Display":
        case "Affiliates":
          var term = _this.getUTMParam(pathparts.href, "content", false);
    ...
    this.queryVars = {};
    this.data = false;
    console.log("attributer.io ready, version ".concat(_VERSION).concat(""));
    this.processData();
